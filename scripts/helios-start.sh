...
export RABBITMQ_TUNNEL_PORT="${RABBITMQ_TUNNEL_PORT:-5673}"
...
export EIS_DOLIBARR_TUNNEL_PORT="${EIS_DOLIBARR_TUNNEL_PORT:-18081}"
...
export EIS_DOLIBARR_API_KEY="${EIS_DOLIBARR_API_KEY:-test_api_key}"
